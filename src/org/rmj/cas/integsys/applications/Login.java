package org.rmj.cas.integsys.applications;

import org.rmj.cas.integsys.fx.IntegSysFX;
...
public class Login {
    public static void main(String [] args){
        ...
        IntegSysFX instance = new IntegSysFX();
    ...
    private static boolean loadProperties(){
        try {
            ...
            System.setProperty("pos.clt.tran.mode", po_props.getProperty("pos.clt.tran.mode"));
