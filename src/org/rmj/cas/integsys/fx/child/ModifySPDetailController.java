...
public class ModifySPDetailController implements Initializable {
        ...
        if(!nv){
            ...
            switch (lnIndex){
                ...
                case 7: //disc rate
                    ...
                    txtField.setText(CommonUtils.NumberFormat(nDiscRate, "0.00"));
                    break;
                case 8: //add disc
                    try {
                        lnValue = Double.parseDouble(lsValue);
    ...
    public void setDiscRate(Number fnDiscRate){nDiscRate = fnDiscRate;}
    public void setAddDiscx(Number fnAddDiscx){nAddDiscx = fnAddDiscx;}
    ...
    public Number getDiscRate(){return nDiscRate;}
    public Number getAddDiscx(){return nAddDiscx;}
    ...
    private static Number nDiscRate = 0.0;
    private static Number nAddDiscx = 0.0;
